...
<div class="row">
	<div class="col-lg-12">
		...
		<a type="button" class="btn btn-success" href="${contextPath}/admin/slider/index">Back To Slider List</a>
	</div>
</div>
<br><br>
<div class="row">
<br>
	<div class="container">
		<div class="col-lg-8">
			<form:form role="form" modelAttribute="slider" method="post"
				...
				<div class="input-field">
					...
					<input id="file-upload" type="file" name="sliderUpload" required="required"/>
				</div>
				<button type="submit"
