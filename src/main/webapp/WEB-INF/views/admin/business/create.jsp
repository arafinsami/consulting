...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Create Our Business</h1>
		<a type="button" class="btn btn-success"
			href="${contextPath}/admin/business/index">Back Our Business List
			Page</a>
	</div>
</div>
<br><br>
		...
		<div class="col-lg-8">
			<form:form role="form" modelAttribute="ourBusiness" method="post"
				...
				<div class="input-field">
					...
					<input id="file-upload" type="file" name="businessUpload"/>
				</div>
				<button type="submit"
